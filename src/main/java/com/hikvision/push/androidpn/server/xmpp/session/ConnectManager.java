...
public class ConnectManager {
	...
	private Map<Integer, String>			channelMap	= new ConcurrentHashMap<Integer, String>();
	...
	public final void addConnect(final Connection connect) {
		...
		if (LOG.isDebugEnabled()) {
			LOG.debug("deviceId=[{}], connect=[{}], add connectMap", deviceId,
					connect);
		}
	...
	public final Connection getConnectByChannelId(final int channelId) {
	 ...
	 * @return
	 */
	public final boolean removeConnect(final int channelId) {
		String deviceid = channelMap.get(channelId);
	...
	public final boolean removeConnect(final int channelId,
		...
		if (channelId != connect.getChannel().getId()) {
			LOG.warn(
					"deviceId=[{}] channelId=[{}] is not this channelId=[{}].",
					deviceid, channelId, connect.getChannel().getId());
			return false;
		}
